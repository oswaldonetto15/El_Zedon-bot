const ownerNumber = ["5567996290141@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5567992690141' 
// mude para seu numero

const callbotmsgs = ['elzedon', 'bot']
...
const urlaudiomenu = 'https://docs.google.com/uc?export=download&id=1-p-w29mToFVWNX8SlURKvG1gb5e4P3nF
...
const menumsgimg = (numero, groupname, bat) => {
    return `MENU DO EL ZEDON BOT COM 434 COMANDOS, BATERIA %${bat}`
}
...
const backgroundmenuimg = `https://images.app.goo.gl/uBZDmNGxZJiTzBDr9`
//Link direto da imagem de fundo TAMANHO RECOMENDADO: 1280x720
//Obs: não coloque o texto longo para a imagem não sumir

const backgroundwelcomeimg = `https://images.app.goo.gl/5g9dgJfXjc2YUaxK8`
//Link direto da imagem de fundo da boas-vindas TAMANHO RECOMENDADO: 1280x720
//Obs: não coloque o texto longo para a imagem não sumir

const backgroundbyeimg = `https://images.app.goo.gl/xfAnpBwS72KxXqJA9`
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5567992690141:+55 67 9269-0141\n' 
+ 'END:VCARD'
